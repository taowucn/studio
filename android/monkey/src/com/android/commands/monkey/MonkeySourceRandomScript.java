...
public class MonkeySourceRandomScript implements MonkeyEventSource {
    ...
    public MonkeySourceRandomScript(String setupFileName, ArrayList<String> scriptFileNames,
        ...
        System.out.println("++ MonkeySourceRandomScript/.  - 0");
		...
		System.out.println("++ MonkeySourceRandomScript/.  - 1  setupFileName=" + setupFileName);
	...
	System.out.println("++ MonkeySourceRandomScript/.  - 1");
        mRandom = random;
	...
	System.out.println("++ MonkeySourceRandomScript/.  - 0  scriptFileNames=" + scriptFileNames);
    }
    ...
    System.out.println("++MonkeySourceRandomScript/getNextEvent - 0");
        ...
        if (mCurrentSource != null) {
		System.out.println("++MonkeySourceRandomScript/getNextEvent - 1");
